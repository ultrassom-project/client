...
export const applySignalGain = (signalVector: number[], reconstructionDimension: ReconstructionDimension) => {
...
const getSignalGainValues = (reconstructionDimension: ReconstructionDimension): SignalGainValues => {
    let N: number;
    let S: number;
