...
import { FormContainer, FileUploadContainer, UploadedFilesContainer, UploadedFileNameContainer, UploadFileButtonContainer } from './styles';
...
const RandomSubmitModal: React.FC<RandomSubmitModalProps> = ({
    isOpen,
    onClose,
    onRandomSubmit
}) => {
    ...
    const handleRemoveFile = useCallback(fileIndex => {
                        ...
                        {signalVectorFiles.length !== 0 && (
                            <UploadedFilesContainer>
                                {signalVectorFiles.map((signalVectorFile, index) => (
                                    ...
                                    >
                                        <Typography>
                                            {signalVectorFile.name} - {signalVectorFilesDimensions[index]}x{signalVectorFilesDimensions[index]}
                                        </Typography>
                                    </UploadedFileNameContainer>
                                ))}
                            </UploadedFilesContainer>
